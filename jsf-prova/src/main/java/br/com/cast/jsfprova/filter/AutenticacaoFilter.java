package br.com.cast.jsfprova.filter;
...
import br.com.cast.jsfprova.managedbean.IdentidadeController;
...
public class AutenticacaoFilter  implements Filter {
	...
	public void doFilter(ServletRequest request, 
		...
		if (isPaginaPermitida) {
			...
			IdentidadeController identidade = (IdentidadeController) session.getAttribute("identidade");
